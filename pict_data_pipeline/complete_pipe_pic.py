...
from pict_data_pipeline.text_split_with_image import generate_split_json
...
def pic_pipeline(sampled_persona: str, figure_type: str, style_map: Optional[Dict[str, Dict[str, float]]]) -> None:
    ...
    split_json = generate_split_json(model = MODEL, text=text, figure_type=figure_type)
    ...
    final_layout = generate_layout(model = MODEL, 
                                   json_=json.dumps(json_with_bbox_sizes, ensure_ascii=False, separators=(",", ":")))
